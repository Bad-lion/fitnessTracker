...
class RunAdapter : RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    val difCallBack = object : DiffUtil.ItemCallback<Run>() {
    ...
    override fun onBindViewHolder(holder: RunViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            forVisible.setOnClickListener {
                if (ivRunImage.visibility == View.GONE){
                    ivRunImage.visibility = View.VISIBLE
                }else{
                    ivRunImage.visibility = View.GONE
                }
            }
        }
    }
